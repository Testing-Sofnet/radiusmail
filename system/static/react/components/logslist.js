...
const GetLogs = () => {
    ...
    const urlSearch = '/api_logs/logs/?search='
    ...
    return (
        <>
            ...
            <Listlogs listlogs={logs} spinner={isLoading} count={info.count} errormsg={errorMessage} terminoBusqueda={terminoBusqueda}/>
...
const root = ReactDOM.createRoot(document.getElementById('logslist'));
root.render(
    <React.StrictMode>
      <GetLogs />
    </React.StrictMode>
